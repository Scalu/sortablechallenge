...
// OriginalMatcherPlusConcurrency the original matching algorithm for this challenge
type OriginalMatcherPlusConcurrency struct {
	products Products
	listings Listings
}

// GetID returns this matcher's ID
func (om *OriginalMatcherPlusConcurrency) GetID() string {
	return "originalMatcherPlusParrallelism"
}

// GetResults returns an array of results produced by the original algorithm
func (om *OriginalMatcherPlusConcurrency) GetResults(products []sortablechallengeutils.Product, listings []sortablechallengeutils.Listing) (results []sortablechallengeutils.Result) {
